...
def initial_data(apps, schema_editor):
    ...
    accounts = [
        account_model(username="Tran Thanh Tu", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
                      role=doctor_role, email="tranthanhtu@gmail.com"),
        account_model(username="Vuong Bao Nhac", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
                      role=doctor_role, email="vuongbaonhac@gmail.com"),
        account_model(username="Ly Uyen Nhi", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
                      role=doctor_role, email="lyuyennhi@gmail.com"),
        account_model(username="Trieu Nha Mong", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
                      role=doctor_role, email="trieunhamong@gmail.com"),
        account_model(username="Bach Tieu Thuan", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
                      role=doctor_role, email="bachtieuthuan@gmail.com"),
        account_model(username="Chu Tieu Nha", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
                      role=doctor_role, email="chutieunha@gmail.com"),
        account_model(username="Nguyen Cong Vinh", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
                      role=doctor_role, email="nguyencongvinh@gmail.com"),
        account_model(username="Le Cao Viet Huy", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
                      role=doctor_role, email="lecaoviethuy@gmail.com"),
        account_model(username="Nguyen Minh Tien", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
                      role=doctor_role, email="nguyenminhtien@gmail.com"),
        account_model(username="Nguyen Thi Lan", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
                      role=doctor_role, email="nguyenthilan@gmail.com"),
        account_model(username="Vu Nguyen", password=make_password(os.getenv('DEFAULT_CUSTOMER_PASSWORD')),
